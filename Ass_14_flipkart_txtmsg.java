...
public class Ass_14_flipkart_txtmsg 
{
	...
	public static void main(String[] args) 
	{
	  ...
	  //WebElement e1=driver.findElement(By.xpath("//div[@class='_1wE2Px']"));
	  //e1.click();
	  
	  //grocery-textmsg
	  WebElement e2=driver.findElement(By.xpath("(//span[.='Grocery'])[2]"));
	  e2.click();
